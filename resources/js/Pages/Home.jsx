                    ...
                    <div className="mt-6 flex flex-col items-center justify-center gap-4">
                        <div className="flex gap-4">
                            <button
                                ...
                                className={`cursor-pointer rounded-full px-6 py-2 font-semibold transition-all duration-200 active:scale-95 ${activeFilter === 'layanan' ? 'bg-[#EF018F] text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                                    }`}
                            >
                                Layanan
                            </button>
                            <button
                                ...
                                className={`cursor-pointer rounded-full px-6 py-2 font-semibold transition-all duration-200 active:scale-95 ${activeFilter === 'checkin' ? 'bg-[#EF018F] text-white' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                                    }`}
                            >
                                Check-in
                            </button>
